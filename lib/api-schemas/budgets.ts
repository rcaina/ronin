...
export const createBudgetSchema = createBudgetBaseSchema.superRefine(
  budgetDateInvariantRefine,
);
...
export const createBudgetWithCardsSchema = z
  .object({
    name: z.string().min(1, "Budget name is required"),
    strategy: z.enum([StrategyType.ZERO_SUM, StrategyType.FIFTY_THIRTY_TWENTY]),
    isRecurring: z.boolean(),
...
export type CreateBudgetWithCardsSchema = z.infer<
  typeof createBudgetWithCardsSchema
>;
