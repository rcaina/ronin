            ...
            {isAddingCategory && activeGroup === group.type ? (
              ...
              !isAddingCategory && (
                <button
                  ...
                  className="flex min-h-[180px] items-center justify-center rounded-2xl border-2 border-dashed border-gray-300 bg-white text-gray-500 transition-all duration-200 ease-out hover:border-secondary hover:bg-secondary/5 hover:text-secondary-700 active:scale-[0.98]"
                >
